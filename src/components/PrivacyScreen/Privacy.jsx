  ...
  return (
    <div className="bg-gray-200 min-h-screen">
      <div className="max-w-6xl mx-auto bg-white shadow-lg rounded-lg px-8 pb-10 pt-[100px] text-gray-800 text-justify leading-relaxed">
        ...
        <h3 className="text-xl font-medium  mb-4">Interpretation</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-medium  mb-4">Definitions</h3>
        ...
        <div className="space-y-4 mb-4">
          ...
          <p>
            <strong>service</strong> means any device that can access the
        ...
        <h3 className="text-xl font-medium  mb-4">Use of your Personal Data</h3>
        <p className="mb-4">
        ...
        <ul className="list-disc list-inside space-y-2 text-justify mb-4">
          <li>
        ...
        <p className="mb-4 font-bold">Disclosure of Your Personal Data</p>
        <p className="font-bold">Business Transactions</p>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-medium  ">Children's Privacy</h3>
        <p className="mb-4">
        ...
        <h4 className="text-xl font-medium  ">Links to Other Websites</h4>
        <p className="mb-4">
