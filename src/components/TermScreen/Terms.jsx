      ...
      <div className="max-w-6xl mx-auto bg-white shadow-lg rounded-lg px-8 pb-10 pt-[100px] text-gray-800 text-justify leading-relaxed">
        ...
        <div className="space-y-4 mb-4 ">
          ...
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Can International, Muni Bhairab Marg, Kathmandu 44600
          </p>
          <p>
          ...
          <p>
            <strong>Website</strong> refers to Can International, accessible
            from{" "}
            <a
              href="https://transport.thecanbrand.com/"
        ...
        <h3 className="text-xl font-semibold">Disputes Resolution</h3>
        <p className="mb-4">
          If You have any concern or dispute about the Service, You agree to
          first try to resolve the dispute informally by contacting the Company.
        </p>

        <h3 className="text-xl font-semibold">For European Union (EU) Users</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl mb-4 font-semibold">Severability and Waiver</h3>
        ...
        <p className="font-semibold">Waiver</p>
        <p className="mb-4">
        ...
        <p className="font-semibold">Translation Interpretation</p>
        <p className="mb-4">
        ...
        <p className="font-semibold">Changes to These Terms and Conditions</p>
        <p className="mb-4">
